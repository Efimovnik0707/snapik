...
namespace SnapBrief.Infrastructure.Exporting;
...
public sealed class FileExportService(IExportImageRenderer renderer, TimeProvider? timeProvider = null) : IExportService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            {
                await JsonSerializer.SerializeAsync(manifestStream, manifest, SnapBriefJson.Options, cancellationToken);
            }
    ...
    private static int CountNotes(SnapBriefSession session) =>
