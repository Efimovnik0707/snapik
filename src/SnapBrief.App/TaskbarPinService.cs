...
internal static class TaskbarPinService
{
    ...
    /// </summary>
    internal const string AppUserModelId = "YesWorkflow.SnapBrief";

    /// <summary>Set this to "off" to walk the branch where pinning fails, without breaking anything.</summary>
    private const string OverrideVariable = "SNAPBRIEF_TASKBAR_PIN";
    ...
    private static string ShortcutName() =>
        $"{Path.GetFileNameWithoutExtension(Environment.ProcessPath) ?? "SnapBrief"}.lnk";
