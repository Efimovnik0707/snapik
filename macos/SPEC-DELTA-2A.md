...
Фейки: вынести из `CodexDesktopPasteCompletionServiceTests.swift` в `Tests/SnapBriefCoreTests/Transport/TransportFakes.swift`; `FakeClipboard.writes: [String]` («PACKAGE:a,b» / путь / «TEXT»), `setPNGGuarded`/`setPackageGuarded` реальные, `externalWrite()`; `FakeInput.afterDispatch`.
...
Новый файл `Sources/SnapBriefMac/App/AppCoordinator+PasteIntent.swift` (из `+Package.swift` уходят `handlePasteIntent`/`completePasteIntent`).
...
## 5. Эхо-наблюдатель
Core `Sources/SnapBriefCore/Transport/ClipboardEchoDetector.swift`:
```swift
...
## Файлы
Новые: `Sources/SnapBriefCore/Transport/ClipboardEchoDetector.swift`, `Sources/SnapBriefMac/App/AppCoordinator+PasteIntent.swift`, `Sources/SnapBriefMac/App/PasteInterceptPredicate.swift`, `Sources/SnapBriefMac/App/AsyncGate.swift`, `Tests/SnapBriefCoreTests/Transport/TransportFakes.swift`, `Tests/SnapBriefCoreTests/Transport/SequentialPasteCompletionServiceTests.swift`, `Tests/SnapBriefCoreTests/Transport/ClipboardEchoDetectorTests.swift`, `Tests/SnapBriefMacTests/App/PasteInterceptPredicateTests.swift`.
Изменяемые: `Sources/SnapBriefCore/Transport/TransportContracts.swift`, `PasteIntentKeyState.swift`, `CodexDesktopPasteCompletionService.swift`, `Sources/SnapBriefMac/Transport/MacPasteIntentObserver.swift`, `MacClipboardService.swift`, `MacInputInjector.swift`, `MacForegroundTargetService.swift`, `Sources/SnapBriefMac/App/AppCoordinator.swift`, `AppCoordinator+Package.swift`, `StatusStrings.swift`, тесты, `CONTRACTS.md`, `README.md`, `SYNC.md`.
