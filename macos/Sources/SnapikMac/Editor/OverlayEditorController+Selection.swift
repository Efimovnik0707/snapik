...
extension OverlayEditorController {
    ...
    /// Finding 13: this is `SessionWorkspace.regionPath` (`Sources/SnapikMac/App`, outside this
    ...
    /// PascalCase keys (`Left/Top/Width/Height/X/Y/W/H`), unlike `SnapikJson`'s camelCase
