...
// Windows needs (`Snapik never injects Enter.`) has no macOS equivalent to port — there is no
...
public final class MacInputInjector: GuardedInputInjecting {
    ...
    /// `MacPasteIntentObserver` can ignore Snapik's own injected keys instead of reacting to them.
