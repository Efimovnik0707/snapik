...
/// Port of the .NET exception types thrown across `src/SnapBrief.Core` and
/// `src/SnapBrief.Infrastructure` (`InvalidDataException`, `ArgumentException`,
...
public enum SnapBriefError: Error, CustomStringConvertible, Equatable {
