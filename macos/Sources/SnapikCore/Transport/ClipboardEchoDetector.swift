...
//
// After Snapik republishes its package for reuse (SPEC-DELTA-2A §4), some receivers "echo"
...
// `watchForReceiverEcho`; this detector tells the two apart so Snapik can silently re-arm its
