// Port of `src/Snapik.App/Controls/ResizeGeometry.cs`, SPEC §2.9.
import Foundation

/// Port of WPF's `Point`. Foundation-only (no CoreGraphics), so this compiles cross-platform
/// alongside the rest of `SnapikCore`.
...
/// Port of `src/Snapik.App/Controls/ResizeGeometry.cs`: shared math for corner-drag resize
