...
public enum UiLanguage {
    ...
    private static let englishPairs: [(String, String)] = [
        ...
        // Sync 2 additions (SPEC-DELTA-2.md §3, order matches `src/Snapik.App/UiLanguage.cs`).
        ...
        // Not present in `src/Snapik.App/UiLanguage.cs` as of this sync — the Windows XAML
