...
| SnapBrief делает скриншот по твоей клавише и кладёт его в чат с ИИ вместе с комментариями. | SnapBrief takes a screenshot on your own shortcut and puts it into an AI chat together with your comments. | A1 |
...
Удалить: `"Выберите язык"`, `"Интерфейс и подсказки будут на этом языке."`, `"Знакомство со SnapBrief"` (A1), `"Показать ярлык"`, `"Не удалось открыть папку с ярлыком"` (A4).
...
| Пункт | Файлы |
|---|---|
| §0-инст + A2-инст | `installer/SnapBrief.iss` |
| §0-прил | `src/SnapBrief.App/OnboardingWindow.xaml.cs`, `src/SnapBrief.App/SmokeTestRunner.cs` |
| A1 | `src/SnapBrief.App/OnboardingWindow.xaml`, `src/SnapBrief.App/OnboardingWindow.xaml.cs`, `src/SnapBrief.App/UiLanguage.cs`, `src/SnapBrief.App/SmokeTestRunner.cs` |
| A2-прил | нет файлов (в приложении уже всё есть) |
| A3 | `src/SnapBrief.App/OnboardingWindow.xaml`, `src/SnapBrief.App/OnboardingWindow.xaml.cs` |
| A4 | `src/SnapBrief.App/OnboardingWindow.xaml`, `src/SnapBrief.App/OnboardingWindow.xaml.cs`, `src/SnapBrief.App/UiLanguage.cs` |
| A5 | `src/SnapBrief.App/Controls/HowToSlides.xaml` *(новый)*, `src/SnapBrief.App/Controls/HowToSlides.xaml.cs` *(новый)*, `src/SnapBrief.App/OnboardingWindow.xaml`, `src/SnapBrief.App/OnboardingWindow.xaml.cs`, `src/SnapBrief.App/UiLanguage.cs`, `src/SnapBrief.App/SmokeTestRunner.cs`, **`src/SnapBrief.App/EdgeStackWindow.xaml.cs`** (одна строка: `:133`) |
| F1 | `src/SnapBrief.App/UiSoundService.cs`, `src/SnapBrief.App/HotkeySettingsWindow.xaml.cs`, `src/SnapBrief.App/Assets/Audio/shutter-1-039s.mp3` *(новый)*, `src/SnapBrief.App/Assets/Audio/shutter-2-050s.mp3` *(удаление)*, `src/SnapBrief.App/SmokeTestRunner.cs`, **`src/SnapBrief.App/EdgeStackWindow.Saving.cs`** (`:11-15`), **`src/SnapBrief.App/EdgeStackWindow.xaml.cs`** (`:172-173`, `:493/:497`, `:870`) |
| F2 | `src/SnapBrief.App/Assets/Audio/README.md` |
...
4. `windows: the wizard shows how to pin SnapBrief` — A4.
...
**xUnit (`tests/SnapBrief.App.Imaging.Tests/`, проект без WPF-окон):**
...
12. Деинсталляция после включённого автозапуска: значение `HKCU\Software\Microsoft\Windows\CurrentVersion\Run\SnapBrief` исчезло.
